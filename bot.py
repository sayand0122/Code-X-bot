...
status = cycle(['Bored in the House', 'Listening to Bad Guy by Billie Eilish',
                'Type commands to see how I function😁', 'Working on my own code', 'Stay Safe', 'College life is Chill'])
...
async def links(ctx):
    myembed = discord.Embed(title='Links to our Social sites',
                            description='', color=discord.Colour.red())
    myembed.add_field(name='Follow us at Instagram',
                      value='*[Instagram](https://www.instagram.com/codex_gitam "Link to our insta page")*', inline=False)
    myembed.add_field(name='View our Github Page',
                      value='*[GitHub](https://github.com/c-code-x "Link to ou github organization")*', inline=False)
    myembed.add_field(name='Our Website', value='[Website]', inline=False)
